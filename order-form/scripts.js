...
var products = [];
    ...
    jQuery("#txtCity").blur(function () {
        validateEmpty("txtCity", "spanCity");
    });
    ...
    jQuery("#btnSubmit").bind('click', function () {
        ...
        $(".product-types .product-qty").each(function () {
            
            var type = $(this).attr("type");
            var product_id = $(this).attr("product_id");
            var qty = $("#qty-" + product_id).val();
            var unit =$("#qty-" + product_id).attr("unit");
            var product =$("#qty-" + product_id).attr("product");
...
function sendForm(data) {
    ...
    jQuery.ajax({
        url: "order-form/send-email.php",
        cache: false,
        dataType: "json",
        type: "POST",
        data: {
            captchacode: jQuery('#captchacode').val(),
            visitor_name: jQuery('#txtName').val(),
