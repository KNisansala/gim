...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>Order | GIM Genaral Trading & Construction </title>
                ...
                <div class="container">
                    <div class="section-content">
                        ...
                        <div class="p-a15 ">
                            ...
                            <div class="wt-box border-2  bg-black-light text-white p-a30">
                                <form>
                                    ...
                                    <button class="site-button " type="submit">Submit <i class="fa fa-angle-double-right"></i></button>
                                </form>
                            </div>                    
                        </div>                          
                    </div>
