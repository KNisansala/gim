                    ...
                    <div class="section-content">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6 col-xs-100pc m-tb15">
                                <div class="wt-team-one bg-white p-a10">
                                    <div class="wt-team-media">
                                        <a href="javascript:void(0);"><img src="images/our-team/pic5.jpg" alt=""></a>
                                    </div>
                                    <div class="wt-team-info text-center  p-a10">
                                        <h4 class="wt-team-title"><a href="javascript:void(0);">Nicolas Cage</a></h4>
                                        <p>Building Worker</p>
                                        <ul class="social-icons social-square social-dark">
                                            <li><a href="javascript:void(0);" class="fa fa-facebook"></a></li>
                                            <li><a href="javascript:void(0);" class="fa fa-twitter"></a></li>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6 col-xs-100pc m-tb15">
                                <div class="wt-team-one  bg-white p-a10">
                                    <div class="wt-team-media">
                                        <a href="javascript:void(0);"><img src="images/our-team/pic6.jpg" alt=""></a>
                                    </div>
                                    <div class="wt-team-info text-center  p-a10">
                                        <h4 class="wt-team-title"><a href="javascript:void(0);">Charlie Sheen</a></h4>
                                        <p>Building Worker</p>
                                        <ul class="social-icons social-square social-dark">
                                            <li><a href="javascript:void(0);" class="fa fa-facebook"></a></li>
                                            <li><a href="javascript:void(0);" class="fa fa-twitter"></a></li>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6 col-xs-100pc m-tb15">
                                <div class="wt-team-one bg-white p-a10">
                                    <div class="wt-team-media">
                                        <a href="javascript:void(0);"><img src="images/our-team/pic7.jpg" alt=""></a>
                                    </div>
                                    <div class="wt-team-info text-center p-a10">
                                        <h4 class="wt-team-title"><a href="javascript:void(0);">Johnny Depp</a></h4>
                                        <p>Building Worker</p>
                                        <ul class="social-icons social-square social-dark">
                                            <li><a href="javascript:void(0);" class="fa fa-facebook"></a></li>
                                            <li><a href="javascript:void(0);" class="fa fa-twitter"></a></li>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6 col-xs-100pc m-tb15">
                                <div class="wt-team-one bg-white p-a10">
                                    <div class="wt-team-media">
                                        <a href="javascript:void(0);"><img src="images/our-team/pic8.jpg" alt=""></a>
                                    </div>
                                    <div class="wt-team-info text-center p-a10">
                                        <h4 class="wt-team-title"><a href="javascript:void(0);">Leonardo  Diaprio</a></h4>
                                        <p>Building Worker</p>
                                        <ul class="social-icons social-square social-dark">
                                            <li><a href="javascript:void(0);" class="fa fa-facebook"></a></li>
                                            <li><a href="javascript:void(0);" class="fa fa-twitter"></a></li>
