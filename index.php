...
<html lang="en"> 
    <head> 
        ...
        <!-- PAGE TITLE HERE -->
        <title>Construction Materials in Sri Lanka |  Construction Materials Suppliers in Sri Lanka | GIM General Trading & Construction Pvt. Ltd</title>
            ...
            <div id="Login-form" class="modal fade " role="dialog">
                <div class="modal-dialog modal-sm">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer text-cent