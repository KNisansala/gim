    ...
    <body id="bg">
        ...
        <div class="page-wraper"> 
            ...
            <div class="page-content">
                ...
                <div class="section-full p-tb100 p-tb100-1">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-6 col-xs-100pc content-box">
                                <div class="section-head text-left text-left-00">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-4 col-xs-100pc p-tb20 squre res-squre">
                                        <div class="wt-icon-box-wraper left">
                                            ...
                                            <div class="icon-content icon-content-text">
                                                ...
                                                <h5 class="wt-tilte text-uppercase m-b0 text-edit">Vision</h5>
                                                <div class="wt-separator-outer underline-1 text-edit">
                                                    <div class="wt-separator style-square">
                                                        <span class="separator-left bg-primary"></span>
                                                        <span class="separator-right bg-primary"></span>
                                                    </div>
                                                </div>
                                                <p>To become a global leading material supply and <br>construction company with quality products and <br>services.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-4 col-xs-4 col-xs-100pc p-tb20 squre">
                                        <div class="wt-icon-box-wraper left">
                                            ...
                                            <div class="icon-content icon-content-text">
                                                ...
                                                <h5 class="wt-tilte text-uppercase m-b0 text-edit">Mission</h5>
                                                <div class="wt-separator-outer underline-1 text-edit">
                                                    <div class="wt-separator style-square">
                                                        <span class="separator-left bg-primary"></span>
                                                        <span class="separator-right bg-primary"></span>
                                                ...
                                                <p>To satisfy the customer requirements in the <br>construction industry.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-4 col-xs-4 col-xs-100pc p-tb20 squre">
                                        <div class="wt-icon-box-wraper left">
                                            ...
                                            <div class="icon-content icon-content-text">
                                                ...
                                                <h5 class="wt-tilte text-uppercase m-b0 text-edit">Values</h5>
                                                <div class="wt-separator-outer underline-1 text-edit">
                                                    <div class="wt-separator style-square">
                                                        <span class="separator-left bg-primary"></span>
                                                        <span class="separator-right bg-primary"></span>
